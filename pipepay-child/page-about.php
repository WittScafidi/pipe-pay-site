...
<section class="pp-page-hero">
    <div class="pp-container">
        ...
        <h1 class="pp-page-title">An independent WooCommerce plugin, built by one merchant for others.</h1>
...
<section class="pp-section pp-section--tight">
    <div class="pp-container pp-container--narrow">
        <div class="pp-prose">
            ...
            <h2>Built by someone who needed it.</h2>
            <p>Pipe Pay is built and operated by Witt Scafidi, a WooCommerce store owner who got tired of reconciling 50+ Venmo, Cash App, and PayPal payments per day against the WooCommerce order list by hand. Every plugin he tried for the workflow assumed a low-friction Stripe-compatible merchant who'd just landed on the wrong page; none of them did the actual reconciliation workflow correctly. So he built one, hardened it on his own stores, and is now selling it to other merchants in the same position.</p>
            <p>The business is being formally entity-registered (US LLC, in progress as of 2026); footer copyright will be updated to reflect the registered legal entity once formation completes. Until then this site is operated as an independent software project under the Pipe Pay name. The plugin source itself is closed-commercial, the customer-facing template files and license-resolver mu-plugin source are visible to any merchant who unzips the customer-download.</p>
