    ...
    <div class="pp-container">
        <article class="pp-story-card">
            ...
            <div class="pp-prose pp-story-prose">
                <p class="pp-story-lead">I run businesses that don't fit cleanly into the major processors' approval boxes - different reasons each time, but the result was the same: a processor that wouldn't take me, a processor that took me and changed its mind, or one that held funds long enough to make planning impossible.</p>
