...
if ( $plain_text ) :
    ...
    echo "On {$stop_label} it stops offering Pipe Pay at checkout until you\n";
    echo "renew. Auto-updates and support pause starting today.\n\n";
...
pp_email_paragraph(
    'Your gateway keeps accepting orders during a 30-day grace period. On <strong>' . esc_html( date_i18n( 'F j, Y', time() + 30 * DAY_IN_SECONDS ) ) . '</strong> it stops offering Pipe Pay at checkout until you renew. Auto-updates and support pause starting today.'
);
