...
if ( $plain_text ) :
    ...
    echo "Just a heads-up: your Pipe Pay {$tier_name} license renews on\n";
    echo "{$expires_label} (30 days from now).\n\n";
...
pp_email_paragraph(
    'Just a heads-up: your Pipe Pay <strong>' . esc_html( $tier_name ) . '</strong> license renews on <strong>' . esc_html( $expires_label ) . '</strong> &mdash; 30 days from now.'
);
